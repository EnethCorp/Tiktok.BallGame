...
namespace KeyAuth
{
    class User
    {
        ...
        public static void Check()
        {
            ...
            if (!KeyAuthApp.response.success)
            {
                ...
                Thread.Sleep(1500);
                Debug.LogError("Exiting KeySystem");
            }

            // Get Key from file
            string key_path = Application.persistentDataPath + "/key";
            Debug.Log(key_path);
            ...
            // Get HWID from file
            string hwid_path = Application.persistentDataPath + "/hwid";
            Debug.Log(hwid_path);
            reader = new StreamReader(hwid_path);
            string hwid = reader.ReadLine();
            Debug.Log(hwid);

            /* CHECK LICENSE */
            KeyAuthApp.license(key, hwid);
            /* ============= */
            ...
            Debug.Log(" IP address: " + KeyAuthApp.user_data.ip);
            Debug.Log(" Hardware-Id: " + KeyAuthApp.user_data.hwid);
        }

        public static IEnumerator AsyncCheck()
        {
    ...
    public class API
    {
        ...
        public void license(string key, string hwid)
        {
            CheckInit();
        ...
        public bool checkblack(string hwid)
        {
            CheckInit();
